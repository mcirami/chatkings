...
Route::group(['middleware' => 'legacy.auth'], function () {
    ...
    Route::group(['prefix' => 'user'], function () {
        ...
        Route::get('{id}/clicks', 'Report\ClickReportController@showUsersClicks')->middleware('role:0,1,2');
    });
    ...
    Route::group(['prefix' => 'offer'], function () {
        ...
        Route::get('{id}/clicks', 'Report\ClickReportController@offerClicks')->middleware('role:0,1,2');
